    ...
    return await openDatabase(
      ...
      onUpgrade: (db, oldVersion, newVersion) async {
        ...
        if (oldVersion < 15) {
          ...
          // Auto-migrate existing items to a default gym
        ...
        if (oldVersion < 17) {
           ...
           try {
             ...
             // Initialize existing gyms as unsynced so they push
